...
local function SQOL_CreateSettingsCategory()
    ...
    AddCheckbox("ColorProgress", "Color quest progress", "Colorize quest and scenario progress messages, the current count of quest objectives in the objective tracker, and quest objective counts on nameplates (red → yellow → green).")
    ...
    AddCheckbox("ShowItemLevel", "Show item level on PlayerFrame", "Show your equipped item level on the player frame, independently of movement speed.")
    AddCheckbox("ShowMovementSpeed", "Show movement speed on PlayerFrame", "Show movement speed on the player frame, independently of item level.")
